...
Slides ([HTML](01-getting-started-with-r/slides/slides.html)/[PDF](01-getting-started-with-r/slides/slides.pdf)) // [Sample Code](01-getting-started-with-r/sample-code.R) // [Free Getting Started with R Online Course](https://rfortherestofus.com/courses/getting-started/)
